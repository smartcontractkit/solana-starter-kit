...
export class TokenAdminRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): TokenAdminRegistryInterface {
    return new Interface(_abi) as TokenAdminRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TokenAdminRegistry {
    return new Contract(address, _abi, runner) as unknown as TokenAdminRegistry;
  }
}
